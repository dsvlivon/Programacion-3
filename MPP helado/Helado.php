<?php
    ...
    class Helado{//Sabor, precio, Tipo (“molde” o “piedra”), cantidad
        public $id;
        public $sabor;
        public $precioBruto;
        public $tipo;
        ...
        function Mostrar(){
            ...
            echo "precio: ".$this->precioFinal."</br>";
            echo "-----------------------</br>";
        }
        public static function Listar($lista){
            foreach ($lista as $obj) {
                ...
                echo "<li>"."precio: ".$obj->precioFinal;
                echo "</ul>";
            }
        }
        public function Equals(Helado $obj){
        ...
        public static function validarStock($lista, $p, $archivo){
            ...
            if($lista != NULL && $p != NULL){
                foreach ($lista as $obj) {
                    if($p->Equals($obj)) {
                        $msg = "Producto Existente!"."</br>"."Stock anterior: ".$obj->cantidad."</br>"."Nuevo Stock: ".$p->cantidad+$obj->cantidad;
                        $obj->cantidad += $p->cantidad;
                        $msg = $msg."</br>Precio anterior: ".$obj->precioFinal."</br>"."Precio nuevo : ".$p->precioFinal;
                        $obj->precioFinal = $p->precioFinal+0;
        ...
        public function GuardarPic($foto){
            ...
            if(move_uploaded_file($foto["tmp_name"],$destino)){
                echo "Foto guardada :".$extension[0]."</br>";
                // $this->foto = $destino;
            } else {
                echo "Error";
                var_dump($foto["error"]);
        ...
        static function ReadJson($archivo){
            ...
            if($archivo!=null)
            {
                ...
                foreach ($auxLista as $obj){
                    ...
                    $x->Setter($obj->id, $obj->sabor, $obj->tipo, $obj->cantidad, $obj->precioBruto);
        ...
        public function Insert() {
            $query = "INSERT into productos (nombre, codigo, tipo, stock, precioFinal, fechaDeCreacion, ultimaModificacion)
